...
export default {
    ...
    mounted () {
        ...
        switch (role.role_name) {
            case 'kitchen':
                this.cards = [
                    {title: 'Task', icon: 'fa fa-2x fa-list-alt', link: 'employee-task-lists'},
                    {title: 'Profil', icon: 'fa fa-2x fa-user', link: 'employee-profile'},
                ]
                break
            case 'waiter':
                this.cards = [
            ...
            case 'supervisor':
                this.cards = [
                    {title: 'Kasir', icon: 'fa fa-2x fa-book-open', link: 'employee-cash-book'},
                    {title: 'Pesanan', icon: 'fa fa-2x fa-list-ul', link: 'employee-orders'},
                    {title: 'Produk', icon: 'fa fa-2x fa-box', link: 'employee-products'},
                    {title: 'Karyawan', icon: 'fa fa-2x fa-users', link: 'employee-employees'},
                ]
                break
        }
    },
