    ...
    <div class="card-dashboard-container">
      ...
      <div v-loading="loading">
          ...
          <div class="width width-30 width-mobile" style="margin-bottom: 30px">
            <div class="card no-padding-mobile box-shadow bg-white">
              <div class="content-center margin margin-bottom-20px">
                <div
                  class="image image-150px border-full"
            ...
            <div class="padding padding-left-30px no-margin-padding">
              ...
              >
                <div class="width width-100">
                  ...
                  <div
                    class="display-flex space-between padding padding-top-10px"
                  >
                    <div
                      class="fonts micro black semibold"
                      style="width: 140px"
                    >
                      Toko
                    </div>
                  ...
                  <div class="display-flex space-between">
                    ...
                    <div style="width: calc(100% - 140px)">
                      ...
                      <div class="fonts micro black">
                        {{ form.shift && form.shift.start_time }} -
                        {{ form.shift && form.shift.end_time }}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="padding padding-left-30px no-margin-padding">
              <div class="card no-padding-mobile box-shadow bg-white">
                ...
                <div class="field-group">
                  ...
                  <div v-if="form.user_username_old" class="field-caption">
                    Username sekarang adalah "{{ form.user_username_old }}".
                  </div>
                  <el-input
                    placeholder=""
                    type="text"
        ...
        <div
          ...
          class="width width-100 padding padding-top-10px padding-bottom-10px"
        >
          <div class="card no-padding-mobile box-shadow bg-white">
...
export default {
  ...
  computed: {
    ...
    getUserImage() {
      return this.form.user_image
        ? this.adminImageThumbnailUrl + this.form.user_image
        : ''
    },
    shopId() {
  ...
  methods: {
    ...
    getData() {
      ...
      this.getById({ token, employee_id: employee_id }).then((res) => {
        const data = {
          ...res.data.data,
          user: {
            ...res.data.data.user,
