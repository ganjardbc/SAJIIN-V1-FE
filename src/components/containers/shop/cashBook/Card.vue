                                    ...
                                    <div class="width width-100">
                                        ...
                                        <div class="display-flex margin margin-top-15px">
                                            ...
                                            <div style="width: calc(100% - 30px); margin-left: 10px;">
                                                ...
                                                <div class="fonts fonts-10 black semibold">{{ format(dt.cashbook.cash_modal || 0) }}</div>
                                            </div>
                                        </div>
                                        <div class="display-flex margin margin-top-15px">
                                            <div class="image image-20px">
                                            ...
                                            <div style="width: calc(100% - 30px); margin-left: 10px;">
                                                ...
                                                <div class="fonts fonts-10 black semibold">{{ format(dt.cashbook.cash_profit || 0) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="display-flex center align-center">
                                        ...
                                        <el-popover 
                                            ...
                                            <div class="width width-100">
                                                ...
                                                <div v-for="(item, i) in dt.cashbook.cash_detail" :key="i" class="display-flex margin margin-top-15px">
