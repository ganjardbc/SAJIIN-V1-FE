      ...
      <div class="margin margin-bottom-20px">
        ...
        <div class="field-group">
          ...
          <el-input
            ...
            :disabled="true"
          ></el-input>
          <div v-if="errorMessage.expense_list_id" class="field-error">
            {{
        ...
        <div class="field-group">
          ...
          ></el-date-picker>
          <div v-if="errorMessage.expense_date" class="field-error">
        ...
        <div class="field-group">
          ...
          <div v-if="errorMessage.expense_price" class="field-error">
  ...
  computed: {
    ...
    getCover() {
      return this.form.image
        ? this.expenseListImageThumbnailUrl + this.form.image
        : ''
    },
    title() {
      let currentTitle = ''
