            ...
            <div class="card small-padding box-shadow bg-white">
                <div class="display-flex align-center">
                    <div style="width: 50px;">
                        <button class="btn btn-icon btn-circle btn-white-grey" @click="onClick">
                            <i class="post-top icn fa fa-lw fa-shopping-cart fonts main-color"></i>
                            <span v-if="orderQuantity" class="notif">{{ orderQuantity }}</span>
                        </button>
                    </div>
                    <div style="width: calc(100% - 90px);">
                        <div class="fonts fonts-10 black">Keranjang</div>
                        <div class="display-flex">
                            <span class="fonts fonts-10 semibold black">{{ orderQuantity }} Produk</span>
                            <span class="fonts black" style="margin: 0 3px;">|</span>
                            <span class="fonts fonts-10 black semibold">{{ format(orderPrice) }}</span>
                        </div>
                    </div>
