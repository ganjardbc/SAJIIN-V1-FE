            ...
            <div class="margin margin-15px margin-mobile-5px">
                <div class="card bg-white box-shadow">
                    <div class="width width-100" style="position: relative;">
                        <div class="image image-padding border-full cursor-pointer" @click="openPopupCart(item)">
                            <img 
                                v-if="item.image" 
                    ...
                    <div class="width width-100">
                        <div class="fonts fonts-11 semibold margin margin-top-10px margin-bottom-5px">{{ item.name }}</div>
