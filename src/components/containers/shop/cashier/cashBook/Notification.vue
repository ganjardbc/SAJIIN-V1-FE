<template>
  <div id="CashierCashBookNotif">
    <el-popover placement="bottom-end" width="310" trigger="click">
      <div class="width width-100">
        <div class="width width-100 change-scrollbar" style="max-height: 300px">
          <el-alert
            title="Mohon Tutup Buku Kas !"
            description="Sepertinya masih ada Buku Kas yang berstatus 'Buka'."
            type="error"
            :closable="false"
            :show-icon="false"
            style="margin: 15px 0"
          ...
          >
            ...
            >
              <div class="display-flex space-between">
                <div class="">
                  <div
                    class="fonts fonts-10 semibold black margin margin-right-5px"
                  >
      ...
      >
        ...
        <span
          v-if="openedCashBook && openedCashBook.length > 0"
          class="notif"
          >{{ openedCashBook && openedCashBook.length }}</span
        >
      </button>
    </el-popover>
  </div>
