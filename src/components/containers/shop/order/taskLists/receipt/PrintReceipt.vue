    ...
    <div class="display-popup" style="z-index: 1000">
      <div class="card-container-popup">
        <div class="card-popup no-padding mobile bg-white box-shadow">
          <div
            class="card-popoup-header display-flex align-center space-between"
          >
          ...
          <div
            v-if="!loading"
            class="card-popup-body padding padding-bottom-50px"
          >
            ...
            <div v-if="printerUrl" class="width width-100">
              ...
              <div v-if="data" class="width width-100">
                <AppEmpty
                  icon="fa fa-3x fa-check-circle"
                  :title="'PRINTER IS CONNECTED'"
                />
                <div class="fonts micro black align-center">
                  You can continue to print this receipt.
                </div>
  ...
  methods: {
    getPrinter() {
      if (this.printerUrl) {
        this.data = null
        this.loading = true
        fetch(this.printerUrl + '/get-device', {
          headers: {
