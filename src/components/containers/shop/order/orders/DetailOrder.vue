    ...
    >
      ...
      >
        <div class="display-flex">
          <div style="width: calc(100% - 75px)">
            ...
            <div v-if="form.cashbook" class="margin margin-bottom-15px">
              <div class="fonts fonts-10 grey">Buku Kas</div>
              <div class="fonts fonts-10 black semibold">
                {{
                  form.cashbook &&
            ...
            <div v-if="form.cashier_name" class="margin margin-bottom-15px">
              <div class="fonts fonts-10 grey">Kasir</div>
              <div class="fonts fonts-10 black semibold">
                {{ form.cashier_name || '-' }}
              </div>
            </div>
      ...
      >
            ...
            <div v-if="form.payment_id" class="display-flex align-center">
              <div class="image image-20px border-full">
                <img
                  ...
                  :src="
                    paymentImageThumbnailUrl +
                    (form.payment && form.payment.image)
                  "
                  alt=""
                  class="post-center"
                />
                <i
                  v-else
                  class="post-middle-absolute icn fa fa-lw fa-image"
                ></i>
              </div>
        ...
        <div
          ...
          class="display-flex space-between margin margin-top-5px margin-bottom-5px"
        >
