  ...
  <div id="App">
    ...
    <div class="width width-100">
      ...
      <div v-loading="loading" class="width width-100">
        <div
          class="width width-100 display-flex space-between align-center margin margin-bottom-10px"
        >
          <div class="fonts fonts-11 semibold black overflow-ellipsis">
            Periode
          </div>
          <div
            class="fonts fonts-10 normal black overflow-ellipsis align-right"
          >
