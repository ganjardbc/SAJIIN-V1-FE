        ...
        <AppCardPopup 
            ...
            <div class="display-flex display-mobile">
                <div class="width width-35 width-mobile">
                    ...
                    <div v-if="filter.report_type === 'custom'" class="field-group padding padding-top-0px">
                    ...
                    <div class="width width-100 padding padding-top-10px padding-bottom-25px">
                        <button 
                ...
                <div 
                    ...
                    <div class="padding padding-left-15px padding-right-15px padding-mobile-none">
                        <div class="display-flex align-center space-between padding padding-bottom-10px">
