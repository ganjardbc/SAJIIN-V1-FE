    ...
    <div class="width width-100">
      ...
      <div class="display-flex wrap">
        <div v-for="(item, i) in data" :key="i" class="column-3 mobile-column">
          <div
            class="margin margin-15px margin-mobile-left-none margin-mobile-right-none"
          >
            <div
              class="card bg-white box-shadow"
              style="overflow: unset; padding-top: 35px; margin-top: 35px"
            >
              <div
                class="post-top-left-absolute"
                style="top: -25px; left: 15px"
              >
                <div class="image image-50px image-circle box-shadow bg-white">
                  <i
                    :class="`post-middle-absolute fonts fonts-12 main-color ${item.icon}`"
                  ></i>
                </div>
              </div>
              ...
              <div
                class="width width-100 margin margin-top-15px padding padding-top-15px border-top"
              >
                <button
                  class="btn btn-sekunder btn-full"
                  @click="onOpenReport(item)"
                >
                  Buat Laporan
                </button>
              </div>
