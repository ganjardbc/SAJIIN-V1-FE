...
const defaultSidebar = [
    {
        icon: 'fa fa-lg fa-database', label: 'MASTERDATA', value: 0, disableMenu: false, menu: [
            {icon: 'fa fa-lg fa-list', label: 'Bizpar', value: 0, link: 'admin-bizpars', permission: 'bizpars'},
            {icon: 'fa fa-lg fa-calculator', label: 'Pembayaran', value: 0, link: 'admin-payments', permission: 'payments'},
        ]
    },
    {
        icon: 'fa fa-lg fa-database', label: 'USER', value: 0, disableMenu: false, menu: [
            {icon: 'fa fa-lg fa-key', label: 'Permission', value: 0, link: 'admin-permissions', permission: 'permissions'},
            {icon: 'fa fa-lg fa-flag', label: 'Role', value: 0, link: 'admin-roles', permission: 'roles'},
            {icon: 'fa fa-lg fa-users', label: 'User', value: 0, link: 'admin-users', permission: 'users'},
        ]
    },
    {
        icon: 'fa fa-lg fa-database', label: 'TOKO', value: 0, disableMenu: false, menu: [
            {icon: 'fa fa-lg fa-store', label: 'Toko', value: 0, link: 'admin-shops', permission: 'shops'},
            {icon: 'fa fa-lg fa-clock', label: 'Shift', value: 0, link: 'admin-shifts', permission: 'employees'},
            {icon: 'fa fa-lg fa-users', label: 'Karyawan', value: 0, link: 'admin-employees', permission: 'employees'},
        ]
    },
    {
        icon: 'fa fa-lg fa-database', label: 'PENGATURAN', value: 0, disableMenu: false, menu: [
            {icon: 'fa fa-lg fa-cogs', label: 'Profil', value: 0, link: 'admin-settings', permission: 'settings'},
        ]
    },
]
