<template>
  <div id="App">
    <el-table :data="data" border empty-text="No Data" style="width: 100%">
      ...
      <el-table-column prop="role_name" label="Nama" width="180">
      </el-table-column>
      <el-table-column prop="description" label="Keterangan" min-width="180">
      </el-table-column>
      <el-table-column prop="type" label="Tipe" min-width="180">
      </el-table-column>
