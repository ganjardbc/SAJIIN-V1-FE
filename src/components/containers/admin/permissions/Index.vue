    ...
    <div class="w-full flex flex-col gap-4 p-4">
      <div class="w-full flex items-center justify-between">
        ...
        <el-button
          ...
          @click="onCreate"
        >
          <i class="fa fa-lw fa-plus mr-2" /> Tambah Permission
        </el-button>
      </div>
    ...
    <div class="left">
      ...
      >
        <div class="width width-75 width-mobile display-flex space-between">
          <h1 class="fonts big black bold">Permission</h1>
        ...
        case 'edit':
          this.updateData({
            ...
            if (status === 'ok') {
              ...
              this.$message({
                message: 'Gagal merubah permission',
                type: 'error',
              })
            }
          })
    ...
    onClickYesDelete() {
      ...
      this.deleteData({
        ...
        if (status === 'ok') {
          ...
          this.titleAlert = 'Gagal menghapus permission'
        }
      })
    },
