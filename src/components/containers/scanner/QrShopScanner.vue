<template>
  <div id="App">
    <AppMobileLayout :title="'Scan Kode QR Toko'">
      <div>
        ...
        <div v-else>
          <div v-if="!selectedIndex" style="padding: 10px 15px">
            <div class="content-center margin margin-10px">
              <div
                class="fonts fonts-16 black semibold"
              ...
              <div class="padding padding-top-15px padding-bottom-15px">
                <div
                  class="card bg-white width width-300px width-center"
                  style="border: 5px #fb3640 solid"
                >
              ...
              <div class="fonts fonts-10 grey">
                Tempatkan kamera pada kode QR untuk mengunjungi Toko terkait.
              </div>
            </div>
          </div>
              ...
              >
                <div style="width: 60px; margin-right: 15px">
                  <div class="image image-padding border border-full">
                    <i
                      v-if="!selectedIndex.shop.image"
                      class="post-middle-absolute fa fa-lg fa-store"
                      style="font-size: 32px; color: #999"
                    />
                    <img
                      v-else
                      :src="shopImageThumbnailUrl + selectedIndex.shop.image"
                      alt=""
                      class="post-center"
                    />
                  </div>
                ...
                <div style="width: calc(100% - 75px)">
                  <!-- <div class="display-flex space-between align-center" style="margin-bottom: 5px;">
                                        ...
                                        <AppCardCapsule :data="selectedIndex.cashbook ? 'open' : 'closed'" />
                                    </div> -->
                  <div class="fonts fonts-11 semibold">
                    {{ selectedIndex.shop.name }}
                  </div>
                  <div class="display-flex">
                    <div
                      style="width: 25px; text-align: center; margin-right: 5px"
                    >
                      <i
                        class="fonts fonts-9 grey fa fa-lg fa-calendar-alt"
                      ></i>
                    </div>
                    <div style="width: calc(100% - 30px)">
                      <div class="fonts fonts-10 normal grey overflow-ellipsis">
                        {{ selectedIndex.shop.open_day }} -
                        {{ selectedIndex.shop.close_day }}
                      </div>
                    </div>
                  </div>
                  <div class="display-flex">
                    ...
                    <div style="width: calc(100% - 30px)">
                      <div class="fonts fonts-10 normal grey overflow-ellipsis">
                        {{ selectedIndex.shop.open_time }} -
                        {{ selectedIndex.shop.close_time }}
                      </div>
                    </div>
                  </div>
                  <div class="display-flex">
                    ...
                    >
                      <i
                        class="fonts fonts-9 grey fa fa-lg fa-map-marker-alt"
                      ></i>
                    </div>
                    <div style="width: calc(100% - 30px)">
                      <div class="fonts fonts-10 normal grey overflow-ellipsis">
                        {{ selectedIndex.shop.location }}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="fonts fonts-10 normal red">
                      Kamu tidak bisa mengunjungi Toko karena sedang tutup.
                    </div>
                  </el-popover>
                  {{ isCashBookOpen ? 'Kunjungi Toko' : 'Toko Tutup' }}
                </button>
...
export default {
  ...
  computed: {
    isCashBookOpen() {
      return (
        this.selectedIndex &&
        this.selectedIndex.cashbook &&
        this.selectedIndex.cashbook.cash_status === 'open'
      )
    },
  },
  methods: {
    ...
    onChangeShop(data) {
      ...
      this.$router.replace({
        name: 'visitor-home',
        params: { shopId: this.selectedShop.shop.shop_id },
      })
    },
    async getByID(id) {
