          ...
          <div class="display-flex card-toast-message-content">
            <div class="left display-flex">
              ...
              <div style="width: calc(100% - 25px)">
                <div v-if="dt.title" class="ttl">
                  {{ dt.title ? dt.title : 'title' }}
                </div>
                <div v-if="dt.subtitle" class="subttl" style="margin-top: 5px">
                  {{ dt.subtitle ? dt.subtitle : 'subtitle' }}
                </div>
              </div>
            </div>
