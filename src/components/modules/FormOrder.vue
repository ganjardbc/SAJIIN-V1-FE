<template>
  <div id="App">
    <div style="padding: 15px 0">
      <div
        v-if="data.order.status !== 'done' && data.order.status !== 'canceled'"
      ...
      >
        ...
        >
          <div style="width: 70px">
            <div
              :class="`image image-circle ${dt.isActive ? 'image-52px' : 'image-45px'}`"
      ...
      <div
        class="border-full"
        style="padding: 15px; margin-bottom: 15px; border-radius: 7px"
      >
        <div class="display-flex">
          <div style="width: calc(100% - 75px)">
            <div class="fonts fonts-11 semibold" style="margin-bottom: 10px">
              {{ data.order.shop_name ? data.order.shop_name : '-' }}
            </div>
            <div class="display-flex" style="margin-bottom: 5px">
              ...
              <div style="width: calc(100% - 30px)">
                <div class="fonts fonts-10 regular">
          ...
          <div style="width: 75px">
            <div class="image image-padding image-radius">
              <img
                ...
                :src="shopImageThumbnailUrl + data.shop.image"
                alt=""
              />
              <i
                v-else
      ...
      >
        <div style="margin-bottom: 10px">
          <div class="fonts fonts-10 grey">Note</div>
          ...
          <div class="width width-70 display-flex">
            ...
            <div style="width: calc(100% - 75px)">
              ...
              <div v-if="dt.product_toping" class="fonts fonts-9 grey">
                {{ dt.quantity }} {{ dt.product_toping }} x Rp.
                {{ dt.toping_price }}
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div class="display-flex space-between" style="margin-bottom: 0">
          ...
          <div class="width width-30">
            <div class="fonts fonts-10 black">
              {{ data.order.payment_status ? 'Paid' : 'Unpaid' }}
            </div>
          </div>
        </div>
        <div class="display-flex space-between" style="margin-bottom: 0">
          <div class="width width-70">
            <div class="fonts fonts-10 black">
              Total Price ({{ data.order.total_item }} Product)
            </div>
          </div>
          <div class="width width-30">
            <div class="fonts fonts-10 black">
              Rp. {{ data.order.total_price }}
            </div>
          </div>
        </div>
      ...
      <div class="border-full" style="padding: 15px; border-radius: 7px">
        ...
        <div style="margin-bottom: 15px">
          <div class="fonts fonts-10 grey">Order Status</div>
          <div
        ...
        <div style="margin-bottom: 15px">
          <div class="fonts fonts-10 grey">Order Date</div>
          <div class="fonts fonts-10 black semibold">
        ...
        <div style="margin-bottom: 0">
          ...
          <div class="fonts fonts-10 black semibold">-</div>
        </div>
      </div>
    </div>
  </div>
...
const defaultPayloadOrderStatus = [
  {
    title: 'Shop confirmed this order',
    subtitle: 'Lorem ipsum doler ismet',
  ...
  {
    title: 'This order is being cooked',
    subtitle: 'Lorem ipsum doler ismet',
