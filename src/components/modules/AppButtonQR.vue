<template>
  <div id="App">
    <button
      ...
      @click="onButtonCustomer"
    >
      {{ title ? title : 'Scan Restaurant QR' }}
      <i :class="'icn ' + (icon ? icon : 'fa fa-lg fa-qrcode')" />
    </button>
    ...
    >
      <div style="padding: 15px 0">
        <div
          ...
          style="width: 300px; margin: auto; padding-bottom: 15px"
        >
        ...
        <div class="content-center" style="padding-bottom: 10px">
          <div class="fonts fonts-11 black semibold">
            Scan this QR-code to make an order
          </div>
