<template>
  <div :class="isMobileCard ? '' : 'display-flex wrap'" id="AppCardGrid">
    ...
    >
      <router-link
        :to="{ name: 'visitor-product-detail', params: { id: dt.product_id } }"
      >
        <div :class="isMobileCard ? '' : 'column-margin'">
          <div
            :class="
              'card no-padding ' +
              (isMobileCard && 'card-mobile ') +
              ' box-shadow'
            "
            :style="isMobileCard ? 'margin-top: 15px;' : 'margin-top: 30px;'"
          >
            <div class="left">
              <div class="cover">
                <img
            ...
            <div class="right">
              <div style="position: relative; width: 100%; margin-bottom: 10px">
                ...
                <div class="fonts fonts-9 grey" style="margin-top: 3px">
                  {{ dt.category }}
                </div>
                <div
                  class="fonts fonts-10 semibold black"
