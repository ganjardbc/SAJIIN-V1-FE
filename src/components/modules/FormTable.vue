<template>
  <div id="FormTable">
            ...
            >
              ...
              <div style="width: calc(100% - 185px)">
                <div class="display-flex" style="margin-bottom: 5px">
                  ...
                  <div
                    :class="
                      'card-capsule ' + (dt.status === 'active' ? 'active' : '')
                    "
    ...
    <AppAlert
      ...
      :title="
        datatable
          ? 'Change to this table ? It will remove your carts and wiselists.'
          : 'Choose this table ?'
      "
...
export default {
  ...
  methods: {
    ...
    async saveTable(payload) {
      ...
      const rest = await axios.post('/api/table/saveTable', payload, {
    ...
    async getData() {
      ...
      const rest = await axios.post('/api/table/getAll', payload, {
        headers: { Authorization: token },
      })
