...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/rolepermission/getAll', params, {
    ...
    createData({ commit, state }, data) {
      ...
      return axios
        .post('/api/rolepermission/post', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/rolepermission/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/rolepermission/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    getDataPermission({ commit, state }, data) {
      ...
      return axios
        .post('/api/permission/getAll', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const payload = res.data.data
