...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/employee/getAll', params, {
    ...
    getById({ commit, state }, data) {
      ...
      return axios
        .post('/api/employee/getByID', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/employee/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/employee/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadCover({ commit, state }, data) {
      ...
      return axios
        .post('/api/employee/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadUserCover({ commit, state }, data) {
      ...
      return axios
        .post('/api/user/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    getDataPosition({ commit, state }, data) {
      ...
      return axios
        .post('/api/position/getAll', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const payload = res.data.data
