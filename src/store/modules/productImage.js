...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/productImage/getAll', params, {
    ...
    createData({ commit, state }, data) {
      ...
      return axios
        .post('/api/productImage/post', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/productImage/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/productImage/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadCover({ commit, state }, data) {
      ...
      return axios
        .post('/api/productImage/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
