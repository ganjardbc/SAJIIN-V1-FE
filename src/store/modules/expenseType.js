...
export default {
    ...
    actions: {
        ...
        createData ({ commit, state }, data) {
            ...
            return axios.post('/api/expense-type/post', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        updateData ({ commit, state }, data) {
            ...
            return axios.post('/api/expense-type/update', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    const data = res.data 
        ...
        deleteData ({ commit, state }, data) {
            ...
            return axios.post('/api/expense-type/delete', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
        ...
        uploadCover ({ commit, state }, data) {
            ...
            return axios.post('/api/expense-type/uploadImage', params, { 
                    headers: { Authorization: data.token } 
                })
                .then((res) => {
                    return res
