...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/discount/getAll', params, {
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/discount/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/discount/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadCover({ commit, state }, data) {
      ...
      return axios
        .post('/api/discount/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
