...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/shipment/getAll', params, {
    ...
    updateData({ commit, state }, data) {
      ...
      return axios
        .post('/api/shipment/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/shipment/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
    ...
    uploadCover({ commit, state }, data) {
      ...
      return axios
        .post('/api/shipment/uploadImage', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
