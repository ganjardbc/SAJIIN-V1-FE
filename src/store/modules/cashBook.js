...
export default {
  ...
  actions: {
    ...
    getData({ commit, state }, data) {
      ...
      return axios
        .post('/api/cashbook/getAll', params, {
    ...
    createData({ commit, state }, data) {
      ...
      const cashDate = data.cash_date
        ? moment(data.cash_date).format('YYYY-MM-DD hh:mm:ss')
        : ''
      const params = {
        ...data,
        cash_date: cashDate,
    ...
    updateData({ commit, state }, data) {
      ...
      const cashDate = data.cash_date
        ? moment(data.cash_date).format('YYYY-MM-DD hh:mm:ss')
        : ''
      const cashEndDate = data.cash_end_date
        ? moment(data.cash_end_date).format('YYYY-MM-DD hh:mm:ss')
        : ''
      const params = {
        ...data,
        cash_date: cashDate,
      ...
      return axios
        .post('/api/cashbook/update', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          const data = res.data
    ...
    deleteData({ commit, state }, data) {
      ...
      return axios
        .post('/api/cashbook/delete', params, {
          headers: { Authorization: data.token },
        })
        .then((res) => {
          return res
